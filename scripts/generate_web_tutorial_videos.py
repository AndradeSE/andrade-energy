...
GENERATOR = [
    ...
    dict(number=3, profile="PORTAL GERADOR", menu=GENERATOR_MENU, active="Clientes", eyebrow="CLIENTES", title="Cadastre cliente e UC", subtitle="O cliente pode ser incluído manualmente ou por conta de energia.", cards=[("CLIENTES ATIVOS", "28", "3 novos no mês"), ("UNIDADES", "34", "32 com contrato"), ("CONSUMO MÉDIO", "18,4 MWh", "Últimos 12 meses")], panel="Clientes cadastrados", panel_note="Abra o cliente e adicione suas unidades consumidoras.", rows=["Vinícius Duarte · 2 UCs", "Sarah Oliveira · 1 UC", "Décio Bento · 3 UCs"], row=0, action="Abrir", cursor=(1120, 459), tip="Dentro do cliente, use Adicionar UC e importe o PDF da concessionária."),
...
if __name__ == "__main__":
    render("tutorial-web-gerador", GENERATOR)
    render("tutorial-web-consumidor", CONSUMER)
