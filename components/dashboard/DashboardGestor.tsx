      ...
      <ScrollView bounces alwaysBounceVertical overScrollMode="always" refreshControl={<RefreshControl refreshing={atualizando} onRefresh={atualizarPagina} tintColor={Colors.primary} colors={[Colors.primary]} />} showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.generationSummary}>
          <View style={styles.generationSummaryTop}>
            <View><Text style={styles.generationEyebrow}>GERAÇÃO DO MÊS</Text><Text style={styles.generationValue}>{formatarEnergia(data.energiaGerada)}</Text><Text style={styles.generationCaption}>Energia produzida na competência atual</Text></View>
            <View style={styles.generationIcon}><Ionicons name="sunny" size={27} color="#F6CC32" /></View>
          </View>
          <View style={styles.generationFooter}><Text style={styles.generationFooterText}>{formatarPercentual(data.ocupacao)} alocada</Text><Text style={styles.generationFooterText}>{formatarEnergia(data.energiaDisponivel)} disponíveis</Text></View>
        </View>
...
const styles = StyleSheet.create({
  ...
  generationSummary: { marginBottom: Spacing.md, padding: Spacing.lg, borderRadius: Radius.xl, backgroundColor: "#0A513E", ...Shadows.card }, generationSummaryTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }, generationEyebrow: { color: "#A7F3D0", fontSize: 11, fontWeight: "900", letterSpacing: 1 }, generationValue: { marginTop: 5, color: "#FFFFFF", fontSize: 30, fontWeight: "900" }, generationCaption: { marginTop: 3, color: "#CDEBDE", fontSize: 12 }, generationIcon: { width: 50, height: 50, alignItems: "center", justifyContent: "center", borderRadius: Radius.round, backgroundColor: "rgba(255,255,255,.12)" }, generationFooter: { flexDirection: "row", justifyContent: "space-between", marginTop: Spacing.lg, paddingTop: Spacing.md, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,.16)" }, generationFooterText: { color: "#D1FAE5", fontSize: 11, fontWeight: "700" },
