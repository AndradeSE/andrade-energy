...
7. Aplicar e verificar a migração `20260924170000_contato_documentos_v1_2.sql`, que substitui o contato inválido por `andradeenergyltda@gmail.com` em novas versões dos termos e políticas, preservando os aceites antigos. Confirmar o recebimento nesse endereço. A tela de cadastro deve permitir abrir os termos integrais antes do aceite; ciência da política não é consentimento genérico para todo tratamento.
