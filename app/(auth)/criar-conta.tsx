...
export default function CriarConta() {
  ...
  async function solicitarAcesso() {
    ...
    try {
      setSalvando(true);
      const resultado = await criarConta({ nome: nome.trim(), cpf, email: email.trim().toLowerCase(), senha, tipo });
          ...
          {!solicitado ? (
            <>
              ...
              <View style={styles.inputBox}>
                ...
                <TextInput autoCapitalize="words" onChangeText={(valor) => { setNome(valor); setErro(""); }} placeholder="Seu nome" placeholderTextColor="#92979F" style={styles.input} value={nome} />
              </View>
              ...
              <View style={styles.inputBox}>
                ...
                <TextInput autoCapitalize="none" autoComplete="email" keyboardType="email-address" onChangeText={(valor) => { setEmail(valor); setErro(""); }} onSubmitEditing={solicitarAcesso} placeholder="seu@email.com" placeholderTextColor="#92979F" returnKeyType="send" style={styles.input} value={email} />
              </View>
