...
export default function Clientes() {
  ...
  return <Screen>
    <AppHeader title="Clientes" subtitle="Gestão da carteira" contextTitle={`${clientes.length} clientes cadastrados`} contextSubtitle="Consumidores que aceitaram o convite" icon="people-outline" />
