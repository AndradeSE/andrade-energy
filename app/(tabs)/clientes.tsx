...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: "row", alignItems: "flex-start" }, avatar: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderRadius: Radius.round, backgroundColor: Colors.primaryLight }, avatarText: { color: Colors.primaryDark, fontSize: Typography.card, fontWeight: "800" }, info: { flex: 1, minWidth: 0, marginHorizontal: Spacing.sm }, name: { color: Colors.text, fontSize: Typography.body, lineHeight: 22, fontWeight: "700" }, documentInfo: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 5 }, detail: { flexShrink: 1, color: Colors.subtitle, fontSize: Typography.small },
  meta: { gap: Spacing.sm, marginTop: Spacing.md, paddingTop: Spacing.md, borderTopWidth: 1, borderTopColor: Colors.border }, metaItem: { minHeight: 24, flexDirection: "row", alignItems: "center", gap: Spacing.sm }, metaText: { flex: 1, color: Colors.subtitle, fontSize: Typography.small }, footer: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: Spacing.md }, openLink: { flexDirection: "row", alignItems: "center", gap: 3 }, openText: { color: Colors.primary, fontSize: Typography.small, fontWeight: "800" },
