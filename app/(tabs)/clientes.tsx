...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: "row", alignItems: "center" }, avatar: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderRadius: Radius.round, backgroundColor: Colors.primaryLight }, avatarText: { color: Colors.primaryDark, fontSize: Typography.card, fontWeight: "800" }, info: { flex: 1, marginHorizontal: Spacing.sm }, name: { color: Colors.text, fontSize: Typography.body, fontWeight: "700" }, ucInfo: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 5 }, detail: { color: Colors.subtitle, fontSize: Typography.small }, document: { marginTop: 4, color: Colors.subtitle, fontSize: Typography.small },
