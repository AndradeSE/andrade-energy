...
const styles = StyleSheet.create({
  ...
  allocationSummary: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", gap: 6, marginTop: Spacing.md, paddingHorizontal: Spacing.sm, paddingVertical: 7, borderRadius: Radius.round, backgroundColor: Colors.primaryLight }, allocationText: { color: Colors.primary, fontSize: Typography.small, fontWeight: "800" },
