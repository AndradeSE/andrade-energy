...
const styles = StyleSheet.create({
  ...
  plantCard: { marginBottom: Spacing.sm, padding: Spacing.md, borderWidth: 1, borderColor: "#C9DED1", borderRadius: Radius.md, backgroundColor: "#F2F8F4" }, activeCard: { borderColor: "#79A98D", backgroundColor: "#EAF4ED" },
