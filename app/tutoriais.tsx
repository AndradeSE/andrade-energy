...
const tutoriaisGerador: Tutorial[] = [
  ...
  { id: "carteira", titulo: "Consultar carteira", descricao: "Veja valores disponíveis e opções financeiras sem realizar uma transferência.", duracao: "23 s", video: require("../assets/tutorials/lote-gerador-financeiro.mp4") },
