...
export default function ClienteDetalhe() {
  ...
  function confirmarSolicitacao() {
    Alert.alert("Confirmar cadastro", `Confirmar os dados de ${cliente.nome} e liberar o acesso ao aplicativo? A conta e a UC extraída da fatura passarão para o status ativo.`, [
