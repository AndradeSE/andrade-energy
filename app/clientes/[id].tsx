...
const styles = StyleSheet.create({ content: { padding: Spacing.lg, paddingBottom: Spacing.xxl }, state: { flex: 1, justifyContent: "center", padding: Spacing.lg }, customerHeader: { marginBottom: Spacing.sm, padding: Spacing.sm, borderRadius: Radius.lg, backgroundColor: "#DEE0E3" }, heading: { flexDirection: "row", alignItems: "center" }, avatar: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderRadius: Radius.round, backgroundColor: Colors.primaryLight }, avatarText: { color: Colors.primaryDark, fontSize: Typography.section, fontWeight: "800" }, headingText: { flex: 1, marginHorizontal: Spacing.sm }, eyebrow: { color: Colors.primary, fontSize: 10, fontWeight: "800", letterSpacing: 1 }, title: { marginTop: 2, color: Colors.text, fontSize: Typography.body, fontWeight: "800" }, subtitle: { marginTop: 2, color: Colors.subtitle, fontSize: Typography.small }, headerInfo: { flexDirection: "row", flexWrap: "wrap", marginTop: Spacing.xs, paddingTop: 4, borderTopWidth: 1, borderTopColor: "rgba(100,116,139,0.18)" }, info: { width: "50%", minHeight: 38, flexDirection: "row", alignItems: "center", paddingRight: Spacing.xs }, infoWide: { width: "100%" }, infoIcon: { width: 25, alignItems: "center" }, infoText: { flex: 1, marginLeft: 3 }, infoLabel: { color: Colors.subtitle, fontSize: 10 }, infoValue: { marginTop: 1, color: Colors.text, fontSize: Typography.small, fontWeight: "600" }, expandButton: { minHeight: 27, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 3, marginTop: 2 }, expandLabel: { color: Colors.primary, fontSize: 10, fontWeight: "700" }, actions: { flexDirection: "row", gap: Spacing.sm, marginBottom: Spacing.lg }, action: { flex: 1 }, whatsapp: { backgroundColor: Colors.success }, reviewCard: { padding: Spacing.md }, reviewHeader: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: Spacing.sm }, reviewTitle: { color: Colors.text, fontSize: Typography.body, fontWeight: "900" }, reviewSubtitle: { maxWidth: 210, marginTop: 4, color: Colors.subtitle, fontSize: Typography.small, lineHeight: 18 }, reviewData: { marginTop: Spacing.sm, paddingTop: Spacing.sm, borderTopWidth: 1, borderTopColor: Colors.border }, invoiceProof: { minHeight: 46, flexDirection: "row", alignItems: "center", gap: Spacing.xs, marginTop: Spacing.sm, paddingHorizontal: Spacing.sm, borderRadius: Radius.md, backgroundColor: Colors.primaryLight }, invoiceProofText: { flex: 1, color: Colors.primary, fontSize: Typography.small, fontWeight: "800" }, attachedInvoices: { padding: Spacing.md }, attachedInvoiceRow: { minHeight: 52, flexDirection: "row", alignItems: "center" }, attachedInvoiceIcon: { width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: Radius.md, backgroundColor: Colors.primaryLight }, attachedInvoiceCopy: { flex: 1, marginHorizontal: Spacing.sm }, attachedInvoiceTitle: { color: Colors.text, fontSize: Typography.small, fontWeight: "900" }, attachedInvoiceText: { marginTop: 3, color: Colors.subtitle, fontSize: 11, lineHeight: 16 }, useAttachedInvoice: { minHeight: 45, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: Spacing.xs, marginTop: Spacing.md, borderRadius: Radius.md, backgroundColor: Colors.primary }, useAttachedInvoiceText: { color: Colors.surface, fontSize: Typography.small, fontWeight: "900" }, approveButton: { minHeight: 54, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: Spacing.xs, marginTop: Spacing.md, borderRadius: Radius.md, backgroundColor: Colors.primary }, approveText: { color: Colors.surface, fontSize: Typography.small, fontWeight: "900" }, disabled: { opacity: 0.7 }, unitActions: { flexDirection: "row", gap: Spacing.sm, marginBottom: Spacing.xs }, search: { minHeight: 52, flex: 1, flexDirection: "row", alignItems: "center", paddingHorizontal: Spacing.md, borderWidth: 1, borderColor: Colors.border, borderRadius: Radius.lg, backgroundColor: Colors.surface }, searchInput: { flex: 1, marginLeft: Spacing.xs, color: Colors.text }, addUnit: { width: 52, height: 52, alignItems: "center", justifyContent: "center", borderRadius: Radius.lg, backgroundColor: Colors.primary }, addUnitInvoice: { backgroundColor: Colors.secondary }, unitActionHint: { marginBottom: Spacing.md, color: Colors.subtitle, fontSize: 11 }, unitCard: { marginBottom: Spacing.sm, padding: Spacing.md, borderWidth: 1, borderColor: "rgba(100,116,139,0.14)", borderRadius: Radius.lg, backgroundColor: "rgba(255,255,255,0.58)", shadowOpacity: 0, elevation: 0 }, unitRow: { minHeight: 58, flexDirection: "row", alignItems: "center" }, unitIcon: { width: 38, height: 38, alignItems: "center", justifyContent: "center", borderRadius: Radius.round, backgroundColor: "rgba(57,128,74,0.10)" }, unitInfo: { flex: 1, minWidth: 0, marginLeft: Spacing.md, marginRight: Spacing.sm }, unitLabel: { color: Colors.subtitle, fontSize: 9, fontWeight: "700", letterSpacing: 0.7 }, unitNumber: { marginTop: 2, color: Colors.text, fontSize: Typography.body, fontWeight: "800" }, unitMeta: { minWidth: 0, flexDirection: "row", alignItems: "center", marginTop: 7 }, statusDot: { width: 6, height: 6, marginRight: 5, borderRadius: 3, backgroundColor: Colors.success }, statusDotInactive: { backgroundColor: Colors.danger }, statusText: { color: Colors.success, fontSize: 10, fontWeight: "800" }, statusTextInactive: { color: Colors.danger }, unitSeparator: { marginHorizontal: 7, color: Colors.border, fontSize: 10 }, unitDetail: { flex: 1, color: Colors.subtitle, fontSize: Typography.small }, summaryLabel: { color: Colors.subtitle }, summaryValue: { marginTop: Spacing.xs, color: Colors.primaryDark, fontSize: 30, fontWeight: "800" }, summaryDetail: { marginTop: Spacing.xs, color: Colors.subtitle }, invoice: { flexDirection: "row", alignItems: "center" }, invoiceIcon: { width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: Radius.md, backgroundColor: Colors.primaryLight }, invoiceInfo: { flex: 1, marginHorizontal: Spacing.sm }, invoiceTitle: { color: Colors.text, fontWeight: "700" }, invoiceDetail: { marginTop: 4, color: Colors.subtitle, fontSize: Typography.small }, invoiceValue: { marginRight: Spacing.sm, color: Colors.text, fontWeight: "700" } });
