...
import { INVERTER_INTEGRATIONS_ENABLED, IS_GERADOR_APP } from "../../config/appVariant";
...
export default function DashboardUsina() {
  ...
  return <Screen>
    ...
    {IS_GERADOR_APP && INVERTER_INTEGRATIONS_ENABLED ? <Button title="Inversores e monitoramento" icon={<Ionicons name="hardware-chip-outline" size={20} color={Colors.surface} />} onPress={() => router.push({ pathname: "/usinas/inversores", params: { id, nome: data.usina?.nome ?? "Usina" } })} style={styles.emailButton} /> : null}
