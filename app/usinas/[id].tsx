...
export default function DashboardUsina() {
  ...
  return <Screen>
    ...
    {IS_GERADOR_APP ? <Button title="Inversores e monitoramento" icon={<Ionicons name="hardware-chip-outline" size={20} color={Colors.surface} />} onPress={() => router.push({ pathname: "/usinas/inversores", params: { id, nome: data.usina?.nome ?? "Usina" } })} style={styles.emailButton} /> : null}
