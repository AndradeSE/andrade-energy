...
const styles = StyleSheet.create({
  content: { padding: Spacing.lg, paddingBottom: Spacing.xxl }, state: { flex: 1, justifyContent: "center", padding: Spacing.lg }, back: { width: 42, height: 42, alignItems: "center", justifyContent: "center", marginBottom: Spacing.md, borderRadius: Radius.round, backgroundColor: Colors.surface }, eyebrow: { color: Colors.primary, fontSize: Typography.small, fontWeight: "800", letterSpacing: 1.1 }, title: { marginTop: Spacing.xs, color: Colors.text, fontSize: Typography.title, fontWeight: "900" }, subtitle: { marginTop: 4, marginBottom: Spacing.md, color: Colors.subtitle }, allocateButton: { marginBottom: Spacing.lg }, metrics: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between" }, metric: { width: "48%", marginBottom: Spacing.sm }, row: { flexDirection: "row", alignItems: "center" }, icon: { width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: Radius.md, backgroundColor: Colors.primaryLight }, info: { flex: 1, marginHorizontal: Spacing.sm }, itemTitle: { color: Colors.text, fontSize: Typography.body, fontWeight: "800" }, itemDetail: { marginTop: 4, color: Colors.subtitle, fontSize: Typography.small }, invoiceTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, invoiceValue: { color: Colors.text, fontSize: Typography.body, fontWeight: "900" }, invoiceBottom: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: Spacing.md, paddingTop: Spacing.sm, borderTopWidth: 1, borderTopColor: Colors.border }, invoiceDate: { flex: 1, color: Colors.subtitle, fontSize: Typography.small }, deleteInvoice: { width: 38, height: 38, alignItems: "center", justifyContent: "center", marginRight: Spacing.xs, borderRadius: Radius.round, backgroundColor: "#FEE2E2" },
});
