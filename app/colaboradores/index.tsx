...
export default function Colaboradores() {
  ...
  return <Screen edges={["top", "left", "right"]}>
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Text style={styles.subtitle}>O colaborador terá login próprio. Carteira, recebíveis, transferências e ferramentas do titular continuam bloqueados.</Text>
      {admin ? <View style={styles.types}><TypeButton active={papel === "COLABORADOR_GERADOR"} label="Equipe do gerador" onPress={() => setPapel("COLABORADOR_GERADOR")}/><TypeButton active={papel === "COLABORADOR_COMERCIAL"} label="Equipe comercial" onPress={() => setPapel("COLABORADOR_COMERCIAL")}/></View> : null}
      ...
      <Text style={styles.title}>Equipe e convites</Text>
