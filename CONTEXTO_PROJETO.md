...
- Nome, CPF e e-mail são informados pelo gerador ao criar o convite; WhatsApp é opcional. No cadastro da conta, o consumidor informa somente senha e a fatura CEMIG em PDF; o backend usa o CPF protegido do convite para abrir e conferir o arquivo e extrai o endereço da própria fatura. Unidade, modalidade, desconto e parâmetros comerciais permanecem na UC, não na ficha do cliente.
