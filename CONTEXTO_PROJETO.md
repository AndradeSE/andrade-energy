...
- Quando a conta ainda não possui qualquer leitura GD, as configurações de faturamento GD ficam bloqueadas e a projeção de desconto real retorna `0,00%`. Elas são liberadas somente após chegar uma competência com energia compensada GD I/GD II ou energia injetada.
