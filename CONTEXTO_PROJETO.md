...
- Nome, CPF e e-mail são informados pelo gerador ao criar o convite; WhatsApp é opcional. No cadastro da conta, o consumidor informa somente senha e a fatura CEMIG em PDF; o backend usa os quatro primeiros dígitos do CPF do convite para abrir e conferir o arquivo, compara nome e CPF e extrai o endereço da própria fatura. Quando a validação confere, a conta fica ativa e o PDF permanece anexado ao cliente. Unidade, modalidade, desconto e parâmetros comerciais permanecem na UC, não na ficha do cliente.
